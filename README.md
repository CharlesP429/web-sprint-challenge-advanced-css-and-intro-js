...
marking up your html to make it easier for visually impared people to use your page.

2. Talk about 3 different things you can do to ensure your website is accessible. 

It is things like making the whole page available to view on different screen sizes. also using certain colors for colorblind people, and descriptive tags like "alt" to describe pictures for screen readers.

3. How would you explain the concept of a variable to someone new to programming?

a variable is a way to store data, like personal data such as name, age, position. or food menus or really anything.

4. What is the purpose of using functions in code?

functions help to bring data to the webpage. you can access data using functions.
