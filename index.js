...
console.log(artists, 2, 6)


/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */
getArtistByIndex("id" 8) {
...
console.log(getArtistByIndex(artists, 0, 1))
...
function removeArtist(artists, "6"){
   artists.pop();
   artists.length;
}
...
function addArtist(artists){
    addArtist(artists){ 
      ...
      bio: "According to all known laws of aviation, there is no way a bee should be able to fly" +
...
function lotsOfArt(artists){
  lotsOfArt("paintings" >100)
  return(artists)
}
console.log(lotsOfArt("paintings" >100))
